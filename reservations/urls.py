...
#    path('supprimer_cite/<int:cite_id>/', mobile.supprimer_cite, name='supprimer_cite'),
    ...
    path('update-langue-client/', mobile.update_langue_client, name='update_langue_client'),
    path('update-langue-joueur/', mobile.update_langue_joueur, name='update_langue_joueur'),
    path('send-message-to-all-joueurs/', mobile.send_message_to_all_joueurs, name='send_message_to_all_joueurs'),
